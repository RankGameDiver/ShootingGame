...
void CGdi::StartDraw(HDC hdc)
{
	...
	m_hbm = CreateCompatibleBitmap( m_hdcScreen, 640, 480 );
...
void CGdi::Blt()
{
	BitBlt( m_hdcScreen, 0, 0, 640, 480, m_hdc, 0, 0, SRCCOPY );
}
...
void CGdi::TextAtPos(float x, float y, const std::wstring& s)
{
